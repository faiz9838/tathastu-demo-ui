...
const DemoCard = () => {
    return (
        <div className="flex flex-col justify-center items-center bg-[#0D0E10] pb-10 overflow-hidden relative w-full -mt-2">

            <div
                className="absolute top-56 z-10 left-[60rem] right-44 bottom-44 bg-cover bg-no-repeat sm:w-44 md:w-32 w-32 md:hidden hidden h-44 bg-center opacity-30"
            ...
            <div className="relative w-[85%] bg-[#141518] text-white p-10  px-10 mt-16 rounded-3xl flex flex-col justify-center items-center overflow-hidden">
                ...
                <div className="flex flex-col w-full sm:w-[75%] md:w-[95%] lg:w-[50%] lg:text-center text-start lg:justify-center md:justify-center sm:text-left">
                    <h1 className="text-3xl sm:text-3xl md:text-xl lg:text-4xl font-semibold leading-snug sm:leading-normal">
                ...
                <div className="flex gap-4 mt-6 flex-wrap w-full  md:mt-10 sm:w-auto justify-start sm:justify-start">
