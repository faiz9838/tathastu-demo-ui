...
const Community = () => {
    return (
        <div className="w-full bg-black flex flex-col items-center px-6 py-16 -mt-2 lg:px-24 lg:py-24">
            {/* Top Section */}
            ...
            <div className="mt-24 w-full bg-gray-900/60 rounded-3xl p-8 relative flex flex-col lg:flex-row gap-8 ">
                <div className="absolute bg-gray-900/100 px-8 py-8  rounded-full -top-10 left-14 shadow-md">
                    <FontAwesomeIcon icon={faQuoteLeftAlt} className="text-white text-4xl" />
                </div>
                <div className="lg:w-2/3 text-white space-y-11">
                    <h2 className="font-normal text-lg lg:text-xl leading-8 my-16 px-6 italic" >
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nam, dignissimos eius?
                        Possimus delectus aut corporis vitae iusto? Laudantium magnam illum similique!
                    </h2>
                ...
                <div className="lg:w-1/3 relative flex justify-center items-end">
                    ...
                    {/* Second Div */}
                    <div className="absolute bg-orange-500 w-40 h-36 rounded-[10rem_0rem_0rem] -bottom-7 left-32 hidden md:block"></div>

                    {/* Image */}
                    <img
                        src={myImg}
                        alt="Person"
                        className="relative z-10 w-60 lg:w-72 filter grayscale contrast-150 -bottom-8 brightness-70 hidden md:block "
                    />
                </div>
